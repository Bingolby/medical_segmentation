...
class Option(object):
    def __init__(self):
        ...
        if self.dataset == 'Digestpath':
            ...
            self.PatchRoot = './data/cervix_data/size_1600_s_400' #!!!!!!!!!!!!!!!!!!
            self.loss_weight = None
        ...
        self.seed = 1632
        self.orig_img_size = 1600#[1600, 400]   #!!!!!!!!!!!!!!!!!!
        self.patch_size = 1536#[1536, 384]      #!!!!!!!!!!!!!!!!!!
        self.batchsize = 5#[3, 48]              #!!!!!!!!!!!!!!!!!!
        self.mini_patch_size = 384
        self.my_batchsize = 16
        self.epochs = 100
        
        self.model_tag = 'Cervix_1600'          #!!!!!!!!!!!!!!!!!!
